...
if(isset($_POST['send'])){
    ...
    if ($amount == $totalPayment)
    {
        ...
        $val= $db->query($sql);
        header("location:../actions/success.php");
...
<div id="order" class="bg-1">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
            <a href="../pages/custCart.php" class="btn btn-danger btn-default pull-left"><span class="glyphicon glyphicon-remove" ></span>Cancel</a>
        </div>
      </div>
    </div>
  </div>
